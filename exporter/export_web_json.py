...
MODULES = {
    "M1": {
        ...
        "description": "Scoring/agregacion de senales H con pulsos de compra y venta.",
        "where": "(hypothesis_code = 'MARKET_INDICATOR_SPX' OR hypothesis_code REGEXP '^M1(_|$)')",
        "preferred_signals": ["MI_SELL_PULSE", "MI_BUY_PULSE"],
    },
    "M2": {
        "title": "M2_BREADTH_DUAL_ML",
        "description": "Score mensual de debilidad/estrés basado en breadth.",
        "where": "hypothesis_code REGEXP '^M2(_|$)'",
    ...
    "M3": {
        ...
        "where": "hypothesis_code REGEXP '^M3(_|$)'",
    ...
    "M4": {
        ...
        "where": "hypothesis_code REGEXP '^M4(_|$)'",
    ...
    "M6": {
        ...
        "description": "Consenso por bloques macro de las senales H activas.",
